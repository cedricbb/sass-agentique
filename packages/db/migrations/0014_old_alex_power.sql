...
ALTER TABLE "client_contacts" ADD COLUMN IF NOT EXISTS "name" text NOT NULL;--> statement-breakpoint
ALTER TABLE "client_contacts" ADD COLUMN IF NOT EXISTS "email" text NOT NULL;--> statement-breakpoint
