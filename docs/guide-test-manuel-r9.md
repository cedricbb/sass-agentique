...
| 2  | A       | 4     | email non envoyé, pas de mail reçu                                                                                                                                                                                                                                 | ~~bloquant~~ **FIXÉ**                                  |             |
| 3  | A       | 6     | Pas de lien vers la facture depuis la page du devis                                                                                                                                                                                                                | gênant                                    | ![img.png](img.png)      |
| 4  | A       | 9     | Pas d'historique visible sur la fiche du client                                                                                                                                                                                                                    | ~~bloquant~~ **FIXÉ**                                  | ![img_1.png](img_1.png)            |
| 5  | A       | 10    | Aucun mails reçu sur Mailhog                                                                                                                                                                                                                                       | ~~bloquant~~ **FIXÉ**                                  |             |
...
| 8  | B       | 2.3   | Aucun historique de facture ni devis sur la fiche du client                                                                                                                                                                                                        | ~~bloquant~~ **FIXÉ**                                  |             |
...
| 13 | B       | 4.2   | Pas de feedback visuel, pas de taost ni rien, uniquement le badge qui change de couleur, modale de confirmation avant de bannir/debannir                                                                                                                           | ~~bloquant~~ **FIXÉ**                                 |             |
...
| 16 | C       | 3.1   | 2 devis sur client-bob@saas.dev aucun devis afficher sur le dashboard                                                                                                                                                                                              | ~~bloquant~~ **FIXÉ**                                  |             |
| 17 | C       | 3.2   | devis status envoyé, pas d'action pour accepter/cecliner le devis                                                                                                                                                                                                  | ~~bloquant~~ **FIXÉ**                                 |             |
